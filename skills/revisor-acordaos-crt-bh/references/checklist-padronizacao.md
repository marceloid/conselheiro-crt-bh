...
| **Secretaria Municipal de Meio Ambiente** | `Secretaria Municipal de Meio Ambiente (SMMA)` | `SMMA` |
| **Prefeitura de Belo Horizonte** | `Prefeitura de Belo Horizonte (PBH)` | `PBH` |
| **Imposto Predial e Territorial Urbano** | `Imposto sobre a Propriedade Predial e Territorial Urbana (IPTU)` | `IPTU` |
...
1. **Leis e Códigos (Regra da Precedência)**:
   - Siglas como `CTN`, `CTM`, `CPC` e `CF/88` só podem ser empregadas após a citação formal completa do diploma legal com respectivo número e ano:
     - `Lei Federal nº 5.172/1966 – Código Tributário Nacional (CTN)`
     - `Lei Municipal nº 1.310/1966 – Código Tributário Municipal (CTM)`
...
3. **Formatos de Decretos, Artigos e Parágrafos**:
   ...
   - `art. 142, caput e parágrafo único, do CTN`
