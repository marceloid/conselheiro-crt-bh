...
14. **Transcrição de Trechos de Ementas no Relatório de REsp (OBRIGATÓRIO)**: Na redação do Relatório de Recursos Especiais (REsp) — tanto na admissibilidade quanto no julgamento de mérito na CER —, é OBRIGATÓRIO reproduzir literalmente os trechos das ementas (com a respectiva verbetação/cabeçalho) do **Acórdão Recorrido** e do **Acórdão Paradigma**, estritamente delimitados à matéria e aos capítulos da divergência jurisprudencial que foi admitida (ou que esteja sob análise de admissibilidade).
15. **Sobriedade e Linguagem Neutra (EVITAR ADJETIVOS E HIPÉRBOLES)**: NUNCA utilize adjetivos ou advérbios exagerados, enfáticos ou hiperbólicos (ex.: "desenganadamente", "extraordinariamente", "umbilicalmente", "absoluta", "barreira intransponível", "peremptoriamente", "flagrante", "gritante"). Adote sempre linguagem técnica, sóbria, neutra, contida e estritamente objetiva, própria da autoridade serena de um órgão colegiado julgador de segunda instância.
16. **Abertura do Voto em Recurso Especial (NUNCA INICIAR COM 'VERSAM OS AUTOS')**: No julgamento de Recurso Especial perante a CER, o Voto NUNCA deve iniciar com a fórmula "Versam os autos". A redação deve abrir delimitando diretamente o objeto do contencioso (a apreciação do mérito do REsp em face do acórdão recorrido) e passando de imediato à análise de cabimento, a qual, no caso de REsp com admissibilidade monocrática prévia, deve tão somente remeter ao despacho irrecorrível do Presidente da Câmara de origem (art. 68 do Decreto nº 18.783/2024 / art. 81 do Decreto nº 19.460/2026), assentando a preclusão consumativa dos tópicos rejeitados e o escopo devolutivo restrito da matéria admitida.
